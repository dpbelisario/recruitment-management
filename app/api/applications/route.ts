...
export async function POST(request: NextRequest) {
  try {
    ...
    const newApplication = {
      ...
      resumeBase64: data.resumeBase64 || null,
      resumeFileName: data.resumeFileName || null,
      resumeSize: data.resumeSize || null,
      resumeUrl: data.resumeBase64 ? `data:application/pdf;base64,${data.resumeBase64.split(',')[1]}` : null,
      skills: [],
      notes: [],
